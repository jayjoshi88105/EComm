...
<body>
  <form class="form-signin" action="server/addproduct.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-label-group">
      <input type="file" name="product_thumb" id="product_thumb" class="form-control">
    </div>
